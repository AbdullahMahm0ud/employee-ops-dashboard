...
import { n as auth } from "./server-v7saif4i.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { r as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-muh3W1A9.js
...
function AppErrorComponent({ error }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-screen flex-col items-center justify-center gap-3 bg-page px-6 text-center text-ink",
		children: [
...
function AppProviders({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(QueryClientProvider, {
		...
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
			position: "top-center",
			toastOptions: { className: "!bg-surface !text-ink !border-line !shadow-soft !font-[Manrope,sans-serif]" }
		})]
	});
}
...
var styles_default = "/assets/styles-DFgOzZjK.css";
var APP_NAME = "StaffPulse";
...
var Route$6 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "StaffPulse — a people ops desk for teams that actually know each other."
			},
			{
				name: "theme-color",
				content: "#1F5C4B"
...
var $$splitComponentImporter$4 = () => import("./routes-BDoipY88.mjs");
var Route$5 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./directory-DuYg9v_s.mjs");
var Route$4 = createFileRoute("/directory")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./login-w_9lSuIJ.mjs");
var Route$3 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./settings-B8nMG8Dm.mjs");
var Route$2 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./employees._id-DWHPfSyc.mjs");
var Route$1 = createFileRoute("/employees/$id")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var rootRouteChildren = {
	...
	EmployeesIdRoute: Route$1.update({
		id: "/employees/$id",
		path: "/employees/$id",
		getParentRoute: () => Route$6
	}),
...
//#endregion
export { Route$1 as n, createSsrRpc as r, router_exports as t };
